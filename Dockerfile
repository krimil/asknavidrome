...
LABEL maintainer="krimil"
LABEL org.opencontainers.image.source=https://github.com/krimil/asknavidrome
...
RUN git clone https://github.com/krimil/asknavidrome.git
